                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        <div className="space-y-8 animate-in fade-in slide-in-from-left-8 duration-1000">
                            ...
                            <h1 className="text-4xl sm:text-6xl font-heading font-black text-slate-main leading-[1.1] tracking-tighter">
                                Tecnologia de Precisão para o <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-primary-light">Sucesso do seu Agronegócio.</span>
                            </h1>

                            <p className="text-lg text-slate-muted font-medium leading-relaxed max-w-lg">
                                Gerencie seus projetos de georreferenciamento, CAR e gestão agrícola em uma plataforma única, intuitiva e focada em resultados reais.
                            </p>
