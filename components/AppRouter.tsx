...
const AppRouter: React.FC<AppRouterProps> = ({
  ...
  const renderView = () => {
    switch (currentView) {
      ...
      />;
      case 'PROJECTS': return <ProjectManagement projects={projects} clients={clients} properties={properties} professionals={professionals} services={services} registries={registries} onAddProject={(t, c, p, prof, s, r, d, cert) => addProject(t, c, p, prof, s, r, d, cert)} onSelectProject={(id) => { setSelectedProjectId(id); setCurrentView('PROJECT_DETAILS'); }} onUpdateProject={(p, id) => handleUpsert('projects', p, fetchInitialData, id)} onDeleteProject={(id) => handleDelete('projects', id)} />;
      ...
      case 'PROPERTIES': return <PropertyList properties={properties} onSaveProperty={(p, id) => handleUpsert('properties', p, fetchInitialData, id)} onDeleteProperty={(id) => handleDelete('properties', id)} />;
