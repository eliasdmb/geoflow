...
ART Nº ${selectedCertification?.art_number || ''}
Cód. Credenciado: ${professional.incra_code || ''}`;

      case 'RECIBO':
        return `RECIBO
 
Recebemos de ${client.name.toUpperCase()}, a importância de R$ ${totalFinal.toLocaleString('pt-BR', { minimumFractionDigits: 2 })} (${numeroPorExtenso(totalFinal)}), referente à quitação parcial/total dos serviços técnicos de ${isCarService ? 'CAR' : 'georreferenciamento'} do imóvel ${property.name.toUpperCase()}.
...
Certificação SIGEF/INCRA: ${selectedCertification?.cert_number || ''}
...
Requerente`;
  ...
  if (!client || !property || !professional) {
    return (
      <div className="fixed inset-0 z-[60] flex bg-slate-900/80 backdrop-blur-sm">
        <div className="bg-white rounded-2xl flex flex-col items-center">
    ...
    <div className="fixed inset-0 z-[60] flex bg-slate-900/80 backdrop-blur-sm">
      <div className="bg-white w-full shadow-2xl flex flex-col animate-in fade-in zoom-in duration-300">
        ...
        <div className="flex-1 min-h-0 flex flex-col md:flex-row bg-slate-100 overflow-hidden relative">
          ...
          <div className="flex-1 overflow-y-auto justify-start bg-gray-100">
            {/* DOCUMENT CONTAINER (A4 SIMULATION) */}
            <div
              ref={docRef}
              className="bg-white shadow-2xl relative text-black font-sans text-[11pt] leading-relaxed print:shadow-none"
              style={{
            ...
            >
              ...
              {step.label === 'Orçamento' ? (
                ...
                <div className="space-y-6 leading-relaxed text-slate-900 w-full" style={{ boxSizing: 'border-box' }}>
                  ...
                  <div className="border border-slate-900 text-[10pt] break-inside-avoid">
                    ...
                    <div className="p-3 grid grid-cols-2 gap-4">
                      ...
                      <div><span className="font-bold uppercase">ART nº:</span> {selectedCertification?.art_number || '__________________________'}</div>
                    </div>
                  </div>
                ...
                <div className="space-y-2 leading-tight text-slate-900 w-full" style={{ boxSizing: 'border-box' }}>
                  ...
                  <div className="mt-4 flex flex-col items-center text-center break-inside-avoid page-break-inside-avoid avoid-break" style={{ breakInside: 'avoid', pageBreakInside: 'avoid' }}>
                    ...
                    <div className="text-[8pt] mt-1 space-y-0.5">
                      ...
                      <p>ART Nº {selectedCertification?.art_number || '________________'}</p>
                ...
                <div className="space-y-8 leading-relaxed text-slate-900" style={{ paddingLeft: '20mm', paddingRight: '20mm', paddingBottom: '10mm', boxSizing: 'border-box' }}>
                  ...
                  <div className="text-justify text-[12pt] leading-relaxed space-y-6">
                    <p className="indent-8">
                      Recebemos de <strong className="uppercase">{client.name}</strong>, a importância de <strong>R$ {totalFinal.toLocaleString('pt-BR', { minimumFractionDigits: 2 })} ({numeroPorExtenso(totalFinal)})</strong>, referente à quitação dos serviços de {isCarService ? 'CAR' : 'georreferenciamento'} do imóvel <strong className="uppercase">{property.name}</strong>.
                    </p>
                ...
                <div
                  className="whitespace-pre-wrap text-slate-900 text-[12pt] text-justify leading-relaxed"
                  style={{
                    boxSizing: 'border-box'
                  }}
                >
              ...
              {step.label === 'Requerimento para o Cartório' && (
                <div className="mt-20 pt-8 flex justify-center text-center mb-10 break-inside-avoid page-break-inside-avoid">
                  <div className="flex flex-col items-center w-80">
                    <div className="w-full border-t border-slate-900 mb-1"></div>
          ...
          <div className="w-80 bg-white border-l border-slate-200 p-6 space-y-6 overflow-y-auto shrink-0 shadow-inner">
